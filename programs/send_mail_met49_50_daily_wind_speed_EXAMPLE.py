...
# KM Hall
# This is an EXAMPLE of the program that emails the met49_50_daily_wind_speed report that
# is suitable for posting to GitHub.
...
subject = "SEV Met 49 and 50 Daily Wind Speed Report"
body = ("Attached is the SEV Met Station 49 and 50 daily wind speed report for {}".format((datetime.date(datetime.now()))))

# The email address that is sending the report
sender_email = "sender@gmail.com"
# The email addresses of those receiving the report
receiver_email = 'receiver_1@unm.edu,receiver_2@unm.edu,receiver_2@unm.edu'
...
# filename = "test.html"
filename = "met49_50_daily_wind_speed_report.html"
